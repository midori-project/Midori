...
export const metadata: Metadata = {
  title: "Login - Midori",
  description: "Login to Midori - AI-powered website generator",
  keywords: "login, signin, Midori, AI website generator",
};
...
function LoginContent() {
  return (
    <div className="h-screen flex overflow-hidden relative">
      ...
      {/* Right side - Login Form overlay (white/semi-opaque panel on top of bg) */}
