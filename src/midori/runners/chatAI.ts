...
import { run as runOrchestrator, Command, CommandType } from '../agents/orchestrator/runners/run';
...
ตอบ JSON เท่านั้น ไม่ต้องอธิบายเพิ่ม:`;
   ...
   */
  private createCommand(analysis: any, message: UserMessage): Command {
    return {
      commandId: randomUUID(),
      commandType: analysis.commandType as CommandType,
      payload: {
